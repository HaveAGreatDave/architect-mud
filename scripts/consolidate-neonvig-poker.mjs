// One-shot: consolidate the Lucky Bastard to a single poker table.
//
...
async function main() {
  ...
  console.log('Done. Reload the world; The Lucky Bastard now has one poker table — Margo\'s old-school felt in the main room.');
  process.exit(0);
}
