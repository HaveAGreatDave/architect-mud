...
// Fuel endurance is calibrated at the x3 baseline game speed: a full tank lasts the
// stated *real* minutes at full-throttle cruise (the flight plugin scales the burn
// with the live game speed, so a faster world drains it proportionally faster). The
// tank size follows directly: fuel_capacity = endurance_min × 28.75 × fuel_burn_base
// (28.75 = the 1.4375 full-throttle-cruise burn factor × 20 ticks/real-min). Endurance
// targets — Mayfly 10, Mule 20, Leviathan 30, Reaper 10; Dragonfly/Carcass left as-is.
const TYPES = [
  { id: 'ac_mayfly',    name: 'Mayfly',    class: 'ultralight', takeoff_mode: 'stol', seats: 1, cargo_capacity: 0,   max_takeoff_weight: 90,   fuel_capacity: 288,  fuel_burn_base: 1.0, fuel_type: 'avgas',   altitude_ceiling: 1, cruise_speed: 1, handling: 2,  hull_hp: 8,  hardpoints: 0, noise: 1, price_buy: 1200,  price_rent_hourly: 40,   engines: 1, data: { feel: 'Cheap trainer you\'ll wreck; the wind tosses it.', endurance_min: 10 } },
  { id: 'ac_dragonfly', name: 'Dragonfly', class: 'heli',       takeoff_mode: 'vtol', seats: 2, cargo_capacity: 40,  max_takeoff_weight: 320,  fuel_capacity: 305,  fuel_burn_base: 1.8, fuel_type: 'avgas',   altitude_ceiling: 2, cruise_speed: 2, handling: -1, hull_hp: 18, hardpoints: 0, noise: 2, price_buy: 8000,  price_rent_hourly: 120,  engines: 1, data: { feel: 'Versatile early pick; thirsty; hovers, lands anywhere flat.' } },
  { id: 'ac_mule',      name: 'Mule',      class: 'prop',       takeoff_mode: 'stol', seats: 3, cargo_capacity: 180, max_takeoff_weight: 620,  fuel_capacity: 748,  fuel_burn_base: 1.3, fuel_type: 'avgas',   altitude_ceiling: 2, cruise_speed: 2, handling: 0,  hull_hp: 30, hardpoints: 0, noise: 2, price_buy: 14000, price_rent_hourly: 220,  engines: 2, data: { feel: 'Freight workhorse; rugged; rough-strip capable.', endurance_min: 20 } },
  { id: 'ac_leviathan', name: 'Leviathan', class: 'heavy',      takeoff_mode: 'strip', seats: 6, cargo_capacity: 600, max_takeoff_weight: 1400, fuel_capacity: 2243, fuel_burn_base: 2.6, fuel_type: 'jet',     altitude_ceiling: 3, cruise_speed: 2, handling: 3,  hull_hp: 55, hardpoints: 0, noise: 3, price_buy: 60000, price_rent_hourly: 900,  engines: 4, data: { feel: 'Economy endgame; an Antonov An-124 Ruslan — heavy and ponderous, slower on top but a strong hauler with the biggest legs in the fleet. Hungry; needs a real runway.', endurance_min: 30 } },
  { id: 'ac_reaper',    name: 'Reaper',    class: 'gunship',    takeoff_mode: 'stol', seats: 2, cargo_capacity: 60,  max_takeoff_weight: 500,  fuel_capacity: 633,  fuel_burn_base: 2.2, fuel_type: 'jet',     altitude_ceiling: 2, cruise_speed: 2, handling: -1, hull_hp: 85, hardpoints: 4, noise: 3, price_buy: 90000, price_rent_hourly: 1500, engines: 2, data: { feel: 'Attack craft, a Fairchild A-10 Warthog — the gun IS the plane. Slow, draggy, armoured; it loiters over the target, shrugs off ground fire, and just keeps coming. Everyone hears the BRRRT.', endurance_min: 10 } },
  { id: 'ac_carcass',   name: 'Carcass',   class: 'wreck',      takeoff_mode: 'stol', seats: 1, cargo_capacity: 0,   max_takeoff_weight: 300,  fuel_capacity: 340,  fuel_burn_base: 2.0, fuel_type: 'biofuel', altitude_ceiling: 1, cruise_speed: 1, handling: 4,  hull_hp: 10, hardpoints: 0, noise: 2, price_buy: 400,   price_rent_hourly: 0,    engines: 1, data: { feel: 'Found downed; rebuild rolls a random type.' } },
];
