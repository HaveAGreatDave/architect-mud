...
const NPCS = [
  ...
  { id: 'npc_breaker_sledge', name: 'Sledge Vurn', sex: 'male', hp: 130, faction: 'faction_breakers', zone: 'zone_meat_slaughter',
    ...
    chit: ['Sledge drags his rebar along the ground, letting it sing off the concrete.', '"This is Breaker ground. You bleed here, you bleed for us."', '"Smash the smart stuff. Keep the dumb stuff. Simple."'] },
  { id: 'npc_breaker_grease', name: 'Grease', sex: 'male', hp: 90, faction: 'faction_breakers', zone: 'zone_meat_slaughter',
    ...
    chit: ['Grease spits, missing your boot on purpose.', '"Keep walking or start paying. Toll\'s whatever I say it is."'] },
  { id: 'npc_breaker_nyla', name: 'Nyla Sparks', sex: 'female', hp: 90, faction: 'faction_breakers', zone: 'zone_meat_slaughter',
    ...
    chit: ['Nyla thumbs a lighter open and shut, open and shut.', '"Everything burns. Circuit boards just burn prettier."'] },
  ...
  { id: 'npc_custodian_ferrin', name: 'Deacon Aldous Ferrin', sex: 'male', hp: 120, faction: 'faction_custodians', zone: 'zone_ruins',
    ...
    chit: ['Ferrin runs a white glove along a broken rail and studies the dust with quiet disappointment.', '"The Architect maintains. We merely file the paperwork."', '"This district is under Custodial care. Kindly do not deface the ruins."'] },
  { id: 'npc_custodian_wren', name: 'Custodian-Adjunct Wren', sex: 'female', hp: 90, faction: 'faction_custodians', zone: 'zone_ruins',
    ...
    chit: ['Wren notes your arrival on a clipboard without looking up.', '"You are not on the approved-access list. I\'ll require a reason. In writing."'] },
  { id: 'npc_custodian_pell', name: 'Sub-Custodian Pell', sex: 'male', hp: 90, faction: 'faction_custodians', zone: 'zone_ruins',
    ...
    chit: ['Pell moves his mop over bare rubble in careful, reverent strokes.', '"Mustn\'t let it get untidy. The Architect notices untidy things."'] },
  ...
  { id: 'npc_glitch_oracle', name: 'Oracle-9', sex: 'female', hp: 110, faction: 'faction_glitch', zone: 'zone_tunnels',
    ...
    chit: ['Oracle-9 tilts her head as if listening to a frequency you can\'t hear.', '"The Architect speaks in dropped packets. We are learning to answer."', '"You\'re standing in the Glitch\'s signal, meat. Mind the interference."'] },
  { id: 'npc_glitch_null', name: 'Null', sex: 'male', hp: 90, faction: 'faction_glitch', zone: 'zone_tunnels',
    ...
    chit: ['Null\'s fingers twitch through a keystroke pattern in the empty air.', '"Access denied. You are not — hkkt — one of us yet."'] },
  { id: 'npc_glitch_hex', name: 'Hex', sex: 'female', hp: 90, faction: 'faction_glitch', zone: 'zone_tunnels',
    ...
    chit: ['Hex watches you with her head cocked, grinning at something only she can see.', '"Ooh. You\'ve got such a pretty little password behind those eyes."'] },
];
