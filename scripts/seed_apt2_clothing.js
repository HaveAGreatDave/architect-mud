...
const items = [
  {
    ...
    weight: 200, value: 180, rarity: 'uncommon',
    tags: {
  ...
  },
  {
    ...
    weight: 300, value: 60, rarity: 'common',
    tags: {
  ...
  },
  {
    id: 'item_gold_chain',
    name: 'gold chain',
    weight: 150, value: 400, rarity: 'uncommon',
    tags: {
  ...
  },
  {
    ...
    weight: 180, value: 220, rarity: 'uncommon',
    tags: {
  ...
  },
  {
    ...
    weight: 600, value: 130, rarity: 'common',
    tags: {
  ...
  },
  {
    ...
    weight: 120, value: 25, rarity: 'common',
    tags: {
  ...
  },
  {
    ...
    weight: 120, value: 350, rarity: 'uncommon',
    tags: {
  ...
  await query(
    `INSERT INTO items (id, name, weight, value, rarity, tags)
     ...
     ON CONFLICT (id) DO UPDATE SET
       ...
       rarity=EXCLUDED.rarity, tags=EXCLUDED.tags`,
    [item.id, item.name, item.weight, item.value, item.rarity, JSON.stringify(item.tags)]
  );
