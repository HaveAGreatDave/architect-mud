...
export const STATIONS = {
  ...
  spar: {
    ...
    gassed: [
      "You're catching with your chest now, because your hands stopped answering.",
    ...
    gain: [
      ...
      "The bounce stops surprising you. It just arrives, and you're already there.",
  ...
  drill: {
    ...
    strong: [
      ...
      "You haul the load the length of the room and set it down soft, because dropping it's quitting.",
      ...
      "You count in your head and lose the number, which means it's going well.",
    ],
    labored: [
      "Your breath is coming in through your teeth now. The load hasn't changed. You have.",
      ...
      "The room is getting longer every trip. That isn't how rooms work.",
    ],
    gassed: [
      ...
      "You're moving on autopilot and the autopilot is also tired.",
    ...
    gain: [
      ...
      "The burn arrives later and leaves faster. That's the whole game.",
