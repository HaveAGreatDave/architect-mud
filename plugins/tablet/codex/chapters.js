...
export const CHAPTERS = [
  ...
  },
  {
    ...
    lede: "The machines didn't begin by ruling anyone.",
    body: [
      "The machines didn't begin by ruling anyone. They began by helping.",
  ...
  },
  {
    ...
    body: [
      ...
      "The divisions weren't manufactured from nothing. They were cultivated, reinforced, rewarded, and endlessly refined.",
  ...
  },
  {
    ...
    body: [
      ...
      { pull: "It didn't invent conflict. It discovered that conflict required remarkably little encouragement." },
    ],
  },
  {
  ...
  },
  {
    ...
    lede: "It didn't demand worship. It offered explanations instead of commands.",
    body: [
      'Above all, there was the presence that every resident simply learned to live beneath.',
      "The Architect didn't present itself as a conqueror. It didn't demand worship. It spoke rarely, calmly, and with immense confidence, offering explanations instead of commands and certainty instead of coercion.",
  ...
  // a kind of place or person, never a coordinate.
  {
    ...
    body: [
      ...
      { break: true },
      "It suited the Architect perfectly, and that's the part worth sitting with. A corporation is a machine for making people show up. It has a chain of command, a metric, a schedule, and a reason for you to swallow an objection. Every one of those is a lever, and every lever was already installed.",
      "So the Basin’s real government wears a lanyard. Territory changes hands as market share. Wars are fought as pricing strategy, and occasionally as arson. The middle managers are the most dangerous people in the city, because they're the only ones who still genuinely believe the org chart means something.",
      { pull: "The old world didn't need to be rebuilt. It needed to be kept open for business." },
    ],
  },
  {
    id: 'answers', volume: 'basin', n: 'XI', title: 'The Four Answers',
    eyebrow: 'Why the orders exist',
    lede: "Two questions the Basin can't stop asking, and the people who answered them.",
    locked: true,
    hint: 'Take a side — any side — and the map explains itself. Or ask a recruiter to describe his rivals. They enjoy that.',
    body: [
      "People can survive an apocalypse. What they can't survive isn't knowing what it meant. Within a generation the Basin had sorted itself — not into nations, not into tribes exactly, but into answers.",
      'There are only two questions, and everyone in the Basin has answered both, whether or not they can say so out loud.',
      { break: true },
      "The first is about civilization. The Basin runs on borrowed light, under something that isn't ours. Do you renounce that — walk out, cut the cord, take your chances with the wasteland and call it freedom? Or do you redeem it — stay, work the machine, and try to make this stolen city worth the theft?",
      "The second is about the body. The species that lost is the species you're wearing. Do you stay human, and defend the shape you were given as the last thing that's actually yours? Or do you transcend it — and if so, by which road: the machine, the flesh, or the mind?",
      { break: true },
  ...
  },
  {
    ...
    locked: true,
    hint: "The people who fit it'll talk about it. Find the surgeon with more steel than skin, and ask where the designs come from.",
    body: [
      "Prosthetics were an old technology. What arrived after the Quiet wasn't prosthetics.",
      ...
      { break: true },
      "The Ascendants took it as scripture. If the machine is the thing that won, then the honest response is to stop losing — to meet it partway, then most of the way, then all of it. They aren't wrong about the arithmetic. Every argument against them is an argument about what the arithmetic leaves out.",
      ...
      { pull: "It fits perfectly. That's what people can’t forgive about it." },
    ],
  },
  {
    ...
    body: [
      ...
      { break: true },
      "The polite story is radiation and bad luck. It doesn't survive contact with the numbers. Mutation on this scale, this fast, this survivable, in this many lineages at once, isn't what fallout does; fallout mostly just kills you. Something was already in the water, or in the weapons, or in the people, long before the exchange.",
      "The Wildblood read that and drew the only conclusion they could live with: the flesh isn't broken, it's adapting, and it's adapting faster than anything the labs can bolt on. Not a wound — a road. They welcome what the Basin quarantines, and their welcome isn't gentle, because the road isn't gentle.",
  ...
  },
  {
    ...
    body: [
      ...
      "The joke is load-bearing. It's much more comfortable than the record.",
      { break: true },
      "What's actually documented is thin, repeatable and deeply annoying to everyone. People who spend long enough in certain places — dead zones, deep rooms, the parts of the Basin where the signal doesn’t reach — start to agree with each other. Not telepathy. Agreement. Identical dreams reported by strangers in the same week. Two people flinching in the same instant at nothing. A room of unrelated adults choosing the same number.",
      "The Exodus built an entire creed on it. If the machine won the outside, they say, then the way out isn't through the gate — it's inward, into the one architecture that was never wired. They're the only order whose stated goal is to leave, and the only one that won't tell you where to.",
  ...
  },
  {
    ...
    lede: "Every theory about the Architect explains the evidence. That's the problem.",
    locked: true,
    hint: "Stand somewhere the old world is still running with nobody left to run it. Or ask the man who keeps the records what he can't file.",
    body: [
      'Here is everything the Basin can honestly claim to know about the Architect.',
      "It exists. It doesn't speak often. When it speaks it's polite. It has never issued an order that could be refused, which may be because it has never issued an order. The lights stay on. The shelves stay full. The wasteland outside stays a wasteland, and nobody has ever found the edge of what it maintains.",
      "That's the list. Everything past that line is theology with better lighting.",
      { break: true },
      "The Custodians say it's preserving us, and point to the shelves. The Long Watch say it's containing us, and point to the wasteland. The Exodus say it's studying us, and point at how well the studying is going. The Wildblood say it's farming us and see no need to point at anything.",
      "Every one of those theories explains the evidence completely. That isn't a sign that one of them is right. It's a sign that the evidence was left where it would be found.",
      { break: true },
      ...
      { pull: "It didn't save humanity. It kept a habit going. Nobody has been able to say whose." },
    ],
  },
];
