...
const MODE_LINES = {
  sports: [
    ...
    '"Watch. Watch. They\'re going to do the stupid thing." A pause. "There it is."',
    '"I had money on that. Not much money. Still money."',
    "makes a noise that isn't quite a word and goes back to what they were doing.",
  ...
  news: [
    ...
    "glances at the set, then very deliberately doesn't look at it again.",
    '"That\'s the third time tonight. Somebody in a booth is asleep on the tape."',
    '"Read it again slower and it still doesn\'t mean anything."',
  ],
  dynamic_news: [
    '"Wait, where was that? Did they say where that was?"',
    '"That\'s four streets from here."',
  ...
  gameshow: [
    ...
    '"For that? They\'re giving away money for THAT?"',
  ],
  talkshow: [
  ...
  morning: [
    '"Too much smiling. It isn\'t a smiling hour."',
    '"They do that voice at this time of day on purpose. It\'s a choice somebody makes."',
    "rubs their eyes and doesn't turn it off.",
  ],
  sermon: [
    ...
    '"He isn\'t wrong. He isn\'t right either, but he isn\'t wrong."',
    "looks at the floor until it's over.",
  ],
  film: [
    '"Oh, this bit. This is the good bit."',
    '"I have seen this one about nine times and I still don\'t know what she wanted."',
    "stops what they're doing for a moment, then remembers themselves.",
    '"They cut this on television. You never get the whole thing."',
  ],
  weather: [
    '"They said that yesterday too."',
    '"Whatever that is, it\'s already happening. I can hear it on the roof."',
  ...
  live_camera: [
    ...
    '"Somebody is standing in a room somewhere with no idea we\'re all looking at them."',
  ],
  commercial: [
    '"I would buy that if I could afford that. I can\'t afford that."',
...
const GENERIC_LINES = [
  ...
  '"Turn it up. No, don\'t turn it up. Leave it."',
  '"{program}. Again."',
