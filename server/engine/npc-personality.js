...
const DEFAULTS = {
  ...
  lowlife: {
    ...
    combat_lines: [
      ...
      'I know people who will not like this.',
      'Take it, take all of it, just stop.',
      'This is a MISUNDERSTANDING.',
      'I was leaving anyway!',
      'You will regret this. Probably. Eventually.',
  ...
  official: {
    ...
    workchitchat: [
      "\"Do you have an appointment? You do not have an appointment.\"",
      "\"That is a different department. On a different floor. In a different building.\"",
      ...
      "\"Everything is in hand. Some of it is in both hands.\"",
      "\"File it correctly and it will be dealt with in due course.\"",
    ...
    lifechitchat: [
      ...
      "\"Civilisation is a filing system. That is not a joke.\"",
      "\"Three hundred applications a week. Three hundred.\"",
      "\"The old world had forms too. That is what people forget.\"",
      "straightens a cuff that did not need it",
      "\"I do not make the rules. I do enforce them, mind.\"",
    ],
    combat_lines: [
      'This is an ASSAULT on a public official!',
      'Do you have any idea of the paperwork this generates?',
      'There are procedures for this!',
      'I am logging every second of this.',
      'You have made an ENEMY of the department.',
      'Security! SECURITY!',
      'This will go in your file. You have a file now.',
      'I am within my rights!',
      'Unhand me at once.',
      'You cannot do this to a man with a desk.',
    ],
    mis_willing: false,
    mis_lines_ok: [
      'This is off the record. Entirely off it.',
      'There is no form for this, which is unusual.',
      'Discretion. I cannot stress that enough.',
      'Not in the building.',
    ],
    mis_lines_no: [
  ...
  clerk: {
    ...
    workchitchat: [
      ...
      "\"If it is not on the list it did not happen.\"",
      "\"I only need one signature. It is a very specific one.\"",
      "runs a finger down a column and stops halfway",
      "\"You are in the wrong queue. There is a right queue.\"",
      "\"Blue ink. It has to be blue ink. I did not decide that.\"",
      "\"Everything gets recorded. That is the entire job.\"",
    ],
    lifechitchat: [
      "\"Do you know what I did today? I found an error from four years ago.\"",
      "\"People think it is dull. It is dull. That is the appeal.\"",
  ...
  professional: {
    ...
    workchitchat: [
      "\"My rate is my rate. It is not a starting position.\"",
      "\"I can do it properly or I can do it Thursday. Not both.\"",
      "\"You are paying for the years, not the hour.\"",
      "\"References available. Most of them are still alive.\"",
      "checks the time in a way that is meant to be noticed",
    ...
    lifechitchat: [
      ...
      "\"I could leave. I have the money to leave. I do not leave.\"",
      "\"Competence is rarer than it should be, and I charge for the difference.\"",
      "\"Do not ask me for free advice. Everybody asks me for free advice.\"",
    ...
    combat_lines: [
      ...
      'You are making an extremely expensive mistake.',
      'I will see you ruined. Legally.',
      'Stop. STOP. Let us talk about this.',
      'Not the hands. I need the hands.',
      'I am worth more to you intact.',
      'Somebody is going to hear about this.',
    ],
    mis_willing: true,
    mis_lines_ok: [
      'Discreetly. That is the only condition.',
      'I have had a week. Yes.',
      'This stays out of the professional sphere.',
      'Fine. But I am not being sentimental about it.',
    ],
    mis_lines_no: [
      'I do not mix business with anything.',
      'No. That is a boundary.',
      'Please do not ask me twice.',
  ...
  labourer: {
    ...
    workchitchat: [
      ...
      "\"Six more of these and it is somebody else's problem.\"",
      "\"Do not stand there. Stand anywhere but there.\"",
      "spits, wipes their hands, and picks the load back up",
      "\"Built it twice already. It will come down twice more.\"",
    ...
    lifechitchat: [
      ...
      "\"Somebody has to hold this city up. Turns out it is us.\"",
      ...
      "\"Rebuild it, watch it fall, rebuild it. That is the whole trade.\"",
    ],
    combat_lines: [
      ...
      'Get off me!',
      'You are going down a hole for this.',
      'I have got nothing but calluses and a temper.',
      'That is my WORKING arm!',
      'Come on then.',
      'This is my site.',
    ],
    mis_willing: true,
    mis_lines_ok: [
      ...
      'Aye, go on then.',
      'I am filthy and I am not apologising for it.',
    ],
    mis_lines_no: [
      'I am working. Look at me, I am working.',
      'Not on the clock.',
      'No. Off you go.',
  ...
  corporate: {
    ...
    workchitchat: [
      ...
      "\"We are not downsizing. We are rightsizing.\"",
      "\"Circle back with me next quarter.\"",
      "\"Shareholder value does not care what happened to the world.\"",
      "checks a device, frowns at it, and smiles at you instead",
      "\"That is a great question and I am going to answer a different one.\"",
    ...
    lifechitchat: [
      ...
      "\"I have an office with a window. It is worth more than a house.\"",
      "\"Loyalty is a line item.\"",
      "\"There is a floor of this building nobody has been to since The Handoff.\"",
  ...
  quiet: {
    ...
    workchitchat: [
      ...
      "\"Mm.\"",
      "answers a question that was not asked out loud",
      "\"It is done.\"",
      "listens for a while longer than is comfortable, then looks away",
      "\"You will manage.\"",
    ],
    lifechitchat: [
      "watches the street go past and does not appear to be waiting for anything",
      "\"It is a quiet one tonight. Good.\"",
      "\"People talk to fill it. I never saw the need.\"",
      "sits very still, in the manner of somebody who has learned to",
      "\"I heard you the first time.\"",
      "\"There is nothing wrong. That is what I keep telling everybody.\"",
    ],
    combat_lines: [
      'No.',
      'Stop.',
  ...
  gruff: {
    ...
    workchitchat: [
      "\"What.\"",
      "\"Say it faster.\"",
      "\"I have not got all day and neither have you.\"",
      "\"It works. It is not pretty. It works.\"",
    ...
    lifechitchat: [
      ...
      "\"They do not build them like this. They do not build them at all.\"",
      "mutters at nothing in particular, at length",
      "\"Leave me be. I am enjoying myself.\"",
    ...
    combat_lines: [
      ...
      'RIGHT.',
      'Come on then, if you are coming.',
      'This is the last straw of a very long day.',
      'You little.',
      'I am too old for this and I am doing it anyway.',
      'Get. Off.',
  ...
  gambler: {
    ...
    workchitchat: [
      ...
      "\"I am due. I am so extremely due.\"",
      "shuffles something one-handed without looking down",
      "\"One more hand. That is all it ever takes.\"",
      "\"The house always wins. Unless it does not, and that is the whole point.\"",
      "\"You have got a tell. I am not telling you what it is.\"",
      "\"I do not gamble. I invest badly and at speed.\"",
    ],
    lifechitchat: [
      "\"I was up eight hundred on Tuesday. Ask anyone.\"",
      "\"Losing is fine. It is the walking home that gets you.\"",
      "\"Everybody in this city is betting on something. I am just honest about the stakes.\"",
      "\"I have a system. It has not worked yet, which means it is nearly ready.\"",
      ...
      "\"Do not lend me anything. Seriously. Do not.\"",
    ],
    combat_lines: [
      ...
      'You are ruining a very good streak.',
      'I have got a system!',
    ],
    mis_willing: true,
    mis_lines_ok: [
      ...
      'Sure. I am on a run.',
      'You are the best thing that has happened to me tonight.',
    ],
    mis_lines_no: [
      'Not tonight. I am concentrating.',
  ...
  charity: {
    ...
    workchitchat: [
      ...
      "\"There is soup. It is not good soup, but there is a lot of it.\"",
      "\"We do not turn anybody away. We have tried. It does not take.\"",
      "hands something over without waiting to be asked",
      "\"If you know somebody who needs it, bring them.\"",
      "\"Warm is warm. Do not be proud about it.\"",
    ],
    lifechitchat: [
      "\"Ran out of blankets by noon. Ran out of coats by one.\"",
      "\"People give more than you would think. Just never enough.\"",
      "\"You cannot fix it. You can feed it. So you feed it.\"",
      ...
      "\"It is not charity if you want something back.\"",
    ],
    combat_lines: [
      'Why? Why would you?',
      ...
      'Somebody stop him!',
      'This is a shelter!',
      'You are hurting people who have nothing!',
      'Please stop. Please.',
  ...
  chatty: {
    ...
    workchitchat: [
      "\"Oh, you will not believe the morning I have had. Sit down. No, sit down.\"",
      ...
      "\"I am not gossiping. I am providing context.\"",
    ],
    lifechitchat: [
      "\"So THEN, right, the drone comes down, and I thought, well, that is Tuesday.\"",
      "\"Nobody talks any more. That is the problem with the world.\"",
      "\"I know a bit about everyone. Not in a sinister way.\"",
      "\"Do you want the short version? There is no short version.\"",
    ...
    mis_lines_no: [
      'Oh. Oh no. No, we are just talking, aren\'t we.',
      'That is a no, and now it is awkward.',
      'Goodness. No. Anyway!',
      'Let us pretend you did not say that.',
    ],
  },
  ...
  stoic: {
    ...
    workchitchat: [
      "\"It will hold.\"",
      "\"There is no use worrying at it.\"",
      "\"Do the work. The rest sorts itself or it does not.\"",
      "\"I have seen worse. That is not comfort, it is just true.\"",
      "carries on without breaking stride",
      "\"Complaining never shifted a single thing.\"",
      "\"One at a time. That is all anybody can do.\"",
    ],
    lifechitchat: [
      "\"The world ended. We are still here. Both facts sit fine together.\"",
      "\"I do not expect much. I am rarely disappointed.\"",
      "\"Weather does what it does.\"",
      "\"Everybody wants it to mean something. It does not have to.\"",
      "stands and watches the street without any evident opinion about it",
      "\"You get up. You go on. That is the trick, and it is not much of one.\"",
...
const HOME_ACTIVITIES = {
  vendor: [
    ...
    '"I am not haggling in my own kitchen."',
  ],
  travelling_vendor: [
    ...
    '"Every place looks the same from a doorway. That is the trick of it."',
    'unrolls a map, finds the crease has eaten a road, and shrugs.',
    'sorts the trinkets into piles by what people actually buy, which is not the pretty pile.',
  ...
  bartender: [
    ...
    '"You know what I do not want to hear about tonight? Anyone else\'s problems."',
    ...
    'wipes a table that is already clean, catches themselves at it, and stops.',
    '"Forty years and I still come home smelling like the place."',
  ],
  dealer: [
    'weighs something out, bags it, and puts it somewhere that is not obvious.',
    'counts a roll of credits under the table even though there is nobody to hide it from.',
  ...
  stripper: [
    ...
    '"You know the worst part? The shoes. It is always the shoes."',
  ...
  unemployed: [
    ...
    '"There is work. There is just no work for me."',
    'counts what is left, which does not take long.',
  ...
  guard: [
    ...
    '"Twelve hours of nothing happening. Then you get home and cannot sit still."',
  ...
  charter_pilot: [
    ...
    '"Weather is turning. It is always turning. That is the job."',
    'checks the sky out the window out of pure habit, at an hour when it tells them nothing.',
    'lays a chart on the table and does not look at it again for an hour.',
  ...
  thug: [
    'ices a hand that is going to be worse tomorrow.',
  ...
  doctor: [
    'washes their hands, then washes them again, and could not tell you why.',
    '"Everyone wants a miracle. I have got gauze."',
    'reads the same page of something clinical three times and gives up.',
    'sets out clean instruments they are not going to use tonight.',
    'sits down and does not move for a full minute, which is the most rest they will get.',
  ],
  politician: [
    ...
    'pours something good and drinks it like it is ordinary.',
    'takes the tie off last, after everything else, as though the costume comes off in order.',
  ],
  preacher: [
    'reads by a poor light and does not put a better one on.',
    ...
    'writes a passage out longhand, which is not faster and is not meant to be.',
  ],
  vagrant: [
    'lays everything they own out on the floor and counts it, because the counting is the ritual.',
    '"Roof. Door. That is a palace, that is."',
  ...
  mercenary: [
    ...
    '"Paid is paid. I am not paid to think about it afterwards."',
    'checks over an old injury the way you would check a tool.',
    'eats what is to hand and sleeps when told to, even by themselves.',
  ...
  scientist: [
    ...
    '"The result is fine. It is the explanation that is wrong."',
    'stares at a wall in a way that is clearly work.',
  ...
  lowlife: [
    ...
    '"I am owed. That is all you need to know about it. I am owed."',
    'hides something somewhere they will not remember tomorrow.',
  ...
  official: [
    ...
    '"There is a form. There is always a form. That is what a civilisation is."',
  ...
  clerk: [
    ...
    '"Do you know how many people this week could not spell their own surname?"',
    'sharpens a pencil that is already sharp.',
  ...
  professional: [
    ...
    'pours something decent and does not enjoy it.',
  ...
  labourer: [
    ...
    '"Back is gone. Back went about nine years ago, if we are honest."',
  ...
  corporate: [
    ...
    '"Restructuring. It is a healthy word. It means healthy things."',
  ...
  charity: [
    ...
    '"There is never enough. You give it out anyway. That is the whole of it."',
  ...
  chatty: [
    ...
    '"Sorry. Am I talking? I am talking. I will stop."',
  ],
  robot: [
