...
export const SKILLS = {
  ...
  firearms:    { id:'firearms',    name:'Firearms',    category:'combat',   stats:['stat_reflexes','stat_senses'] },
  explosives:  { id:'explosives',  name:'Explosives',  category:'combat',   stats:['stat_brains'] },
  dodge:       { id:'dodge',       name:'Dodge',       category:'combat',   stats:['stat_reflexes','stat_senses'] },
  scavenging:  { id:'scavenging',  name:'Scavenging',  category:'survival', stats:['stat_senses','stat_brains'] },
  cooking:     { id:'cooking',     name:'Cooking',     category:'survival', stats:['stat_brains'] },
  medicine:    { id:'medicine',    name:'Medicine',    category:'survival', stats:['stat_brains','stat_senses'] },
  navigation:  { id:'navigation',  name:'Navigation',  category:'survival', stats:['stat_senses','stat_brains'] },
  ...
  security:    { id:'security',    name:'Security',    category:'tech',     stats:['stat_senses','stat_brains'] },
  persuasion:  { id:'persuasion',  name:'Persuasion',  category:'social',   stats:['stat_cool','stat_senses'] },
