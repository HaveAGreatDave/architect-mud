...
(function (global) {
  const TAG_CATALOG = {
    ...
    terrain: { label: 'Terrain', shape: 'enum', options: ['water', 'underwater', 'road', 'dirt_road', 'asphalt', 'concrete', 'grass', 'park', 'dirt', 'sand', 'gravel', 'dock', 'scrub', 'redrock', 'ash', 'marsh', 'sewer'], scope: 'zone', group: 'Zone: Structure',
