...
(function (global) {
  const TAG_CATALOG = {
    ...
    food_profile: { label: 'Food Profile', shape: 'enum', scope: 'class', group: 'Cooking',
      options: ['dense_meat', 'starchy_vegetable', 'soft_vegetable', 'fruit', 'liquid', 'batter', 'egg', 'preserved', 'fat_or_oil', 'aromatic'],
    ...
    vessel_kind: { label: 'Vessel Kind', shape: 'enum', scope: 'class', group: 'Cooking',
      options: ['pan', 'pot', 'tray', 'bowl'],
      help: 'Which dishes this vessel can produce — a stew needs a pot, a sear needs a pan, a roast needs a tray, a dip needs a bowl (plugins/cooking/dishes.js). A bowl is worked, not heated. Only meaningful alongside `vessel`; a vessel without it still cooks its contents but can never resolve them into a dish.' },
