...
(function (global) {
  const TAG_CATALOG = {
    ...
    boat: { label: 'Boat', shape: 'flag', scope: 'class', group: 'Systems',
      help: 'Carrying this lets the player cross water zones (movement).' },
    ...
    checkpoint: { label: 'Checkpoint', shape: 'flag', scope: 'zone', group: 'Zone: Systems',
      help: 'Checkpoint gate zone (govgate).' },
