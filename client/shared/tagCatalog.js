...
(function (global) {
  const TAG_CATALOG = {
    ...
    vessel_kind: { label: 'Vessel Kind', shape: 'enum', scope: 'class', group: 'Cooking',
      options: ['pan', 'pot', 'tray'],
      help: 'Which dishes this vessel can produce — a stew needs a pot, a sear needs a pan, a roast needs a tray (plugins/cooking/dishes.js). Only meaningful alongside `vessel`; a vessel without it still cooks its contents but can never resolve them into a dish.' },
