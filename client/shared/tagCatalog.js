...
(function (global) {
  const TAG_CATALOG = {
    ...
    terrain: { label: 'Terrain', shape: 'enum', options: ['water', 'road', 'asphalt', 'concrete', 'grass', 'park', 'dirt', 'sand', 'gravel', 'dock', 'scrub', 'redrock', 'ash', 'marsh'], scope: 'zone', group: 'Zone: Structure',
